...
public class DaoCategory extends BasicDao implements IDaoCategory{
	...
	public DaoCategory((@Value("${db.address}")String dbAddress,
	...
	public void addCategory(Category c) {
		execute("INSERT INTO categories(nome) VALUES (?)",c.getNome());
	}
	...
	public void updateCategory(Category c) {
		execute("UPDATE categories SET nome=? WHERE id=?",c.getNome(),c.getId());
	}
