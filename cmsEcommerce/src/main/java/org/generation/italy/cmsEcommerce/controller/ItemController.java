...
import org.generation.italy.cmsEcommerce.dao.IDaoItem;
...
public class ItemController {
	...
	@GetMapping("/type/{typeId}/size/{size}/color/{color}")
	public Item getOneBySizeAndId(@PathVariable int typeId, 
			@PathVariable String size,
			@PathVariable String color) {
		
		return dao.getItemBySizeAndColor(typeId, size, color);
	}
